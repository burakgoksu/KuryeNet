...
public class Utils {
    ...
    public class Const {
        ...
        public static final String OPEN_WEATHER_MAP_KEY = "0dccf02989ec87da3388e40cb37dba15";
    ...
    public ErrorDataResult<ApiError> getErrorsIfExist(BaseCheckService... baseCheckServices) {
        ...
        if (!errors.isEmpty()) return new ErrorDataResult<>( new ApiError(errors),Msg.FAILED.get());
        else return null;
    }
